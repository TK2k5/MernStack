...
4. accumulator: giá trị tích lũy (gía trị mà bạn muốn tính toán qua từng vòng lặp). Nó bắt đầu từ
   initialValue và được cập nhật sau mỗi lần lặp
5. currentValue: giá trị của phần tử hiện tại trong mảng sau mỗi lần lặp
6. currentIndex: chỉ số của phần tử hiện tại trong mảng
7. array: mảng được duyệt
   \*/
